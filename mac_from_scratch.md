...
по половинам, углам и другим зонам экрана.
...
- **Скорость повтора клавиш** — на максимальное значение
- **Задержка до повтора** — на минимальное значение

Для более точной настройки можно полностью убрать задержку через терминал:
